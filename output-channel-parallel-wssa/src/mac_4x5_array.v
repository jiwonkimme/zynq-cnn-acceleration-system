...
module mac_4x5_array(
    ...
    wire signed [31:0] after_sum_5 [0:3];

    // column 별로 4행에 대한 assign
    assign  x_i_1    =   I [39:32];
    assign  x_i_2    =   I [31:24];
    assign  x_i_3    =   I [23:16];
    assign  x_i_4    =   I [15:8];
    assign  x_i_5    =   I [7:0];

    assign  w_i_1    =   W [39:32];
    assign  w_i_2    =   W [31:24];
    assign  w_i_3    =   W [23:16];
    assign  w_i_4    =   W [15:8];
    assign  w_i_5    =   W [7:0];
    ...
    */
    ...
    always @(posedge clk or negedge rstn) begin
        if(!rstn) begin
            ...
            stop_mac_5_4d[0]    <=  1'd0;
            stop_mac_5_4d[1]    <=  1'd0;
            stop_mac_5_4d[2]    <=  1'd0;
            stop_mac_5_4d[3]    <=  1'd0;
            ...
            x_i_5_4d[0]         <=  x_i_5;
            x_i_5_4d[1]         <=  x_i_5_4d[0];
            x_i_5_4d[2]         <=  x_i_5_4d[1];
            x_i_5_4d[3]         <=  x_i_5_4d[2];
            ...
            stop_mac_5_4d[0]    <=  stop_mac_pipe;
            stop_mac_5_4d[1]    <=  stop_mac_5_4d[0];
            stop_mac_5_4d[2]    <=  stop_mac_5_4d[1];
            stop_mac_5_4d[3]    <=  stop_mac_5_4d[2];
...
//-----------------Column 5 start-------------------
    mac_4x1_col col5(
        ...
        .en_x_i(en_x_i),
        .en_w_i(en_w_i[0]),
        .stop_mac(stop_mac_5_4d[3]),
        .used_row(used_row_pipe),
        .before_sum_1(after_sum_4[0]),
        .before_sum_2(after_sum_4[1]),
        .before_sum_3(after_sum_4[2]),
        .before_sum_4(after_sum_4[3]),
        .x_i(x_i_5_4d[3]),
        .w_i(w_i_5),
        .after_sum_1(after_sum_5[0]),
        .after_sum_2(after_sum_5[1]),
        .after_sum_3(after_sum_5[2]),
        .after_sum_4(after_sum_5[3])
    );
//-----------------Column 5 end-------------------
